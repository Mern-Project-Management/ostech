...
import { FaUsers, FaHandshake, FaTruck } from 'react-icons/fa';
  ...
  const values = [
    {
      icon: <FaUsers />,
      title: "Team Work",
      description: "We emphasize on team work because we believe no task is impossible when like-minded people with the same goal come together."
    },
    {
      icon: <FaHandshake />,
      title: "Dedication",
      description: "We strive to achieve success and meet our client's expectations with unconditional dedication and support."
    },
    {
      icon: <FaTruck />,
      title: "Deliver Excellence",
      description: "We boast to deliver superior quality products, with efficient procedures. Therefore our customers choose to partner with us."
    }
  ];
  ...
  const renderSlide = (value) => (
    <div className="px-2 md:px-4 w-full">
      <div className="bg-white p-4 md:p-8 lg:p-12 rounded-lg w-full max-w-sm mx-auto
        ...
        <div className="text-3xl md:text-4xl lg:text-5xl mb-4 md:mb-6 
                      flex items-center justify-center
                      transform transition-all duration-500 
                      hover:scale-110 hover:rotate-12 text-[#1290ca]">
          {value.icon}
        </div>

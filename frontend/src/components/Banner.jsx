...
function Banner({ backgroundImage, title = "Default Banner Title" }) {
    return (
        <div className='relative w-full bg-gray-50'>
            ...
            >
                <div className='flex justify-center items-center h-[40vh] mb-10 relative'>
                    <h1 className='font-bold text-white text-5xl z-10'>{title}</h1>
